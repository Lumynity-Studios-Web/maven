...
echo.
echo SUBPATH
echo *Destination inside net\justmili\
set /p artifact_subpath=">> "
echo.
...
if "%artifact_subgroup%" == "" (
    set full_group=net.justmili
) else (
    set full_group=net.justmili.%artifact_subgroup%
)

set source_file=jars\%artifact_name%.jar
set artifact_dest=net\justmili\%artifact_subpath%
